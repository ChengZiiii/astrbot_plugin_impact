...
class ImpactConfig:
    ...
    def from_dict(raw: dict | None) -> ImpactConfig:
        ...
        return ImpactConfig(
            ...
            dajiao_media_mode=str(config.get("dajiao_media_mode", "none")).strip() or "none",
            suo_media_mode=str(config.get("suo_media_mode", "none")).strip() or "none",
            pk_media_mode=str(config.get("pk_media_mode", "none")).strip() or "none",
            yinpa_media_mode=str(config.get("yinpa_media_mode", "none")).strip() or "none",
